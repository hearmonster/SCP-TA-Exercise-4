sap.ui.define([
	...
	const initialValues = {
		...
		return BaseController.extend("ns.IncidentReportPXXXXXX.controller.Create", {
            onInit: function () {
		...
		var data = this.getView()
            ...
            if (data.title != "" && data.description != "") {
				...
				var settings = {
					async: true,
					url: "/nsIncidentReportPXXXXXX/Incidents_CF/incident/SafetyIncidents",
					method: "POST",
					headers: {
        ...
        createPicture: function (response) {
			...
			var settings = {
				async: true,
				crossDomain: true,
				url: "/nsIncidentReportPXXXXXX/Incidents_CF/incident/IncidentPhotos",
				"method": "POST",
				"timeout": 0,
				"headers": {
					"content-type": "application/json"
        ...
        uploadPicture: function (response) {
			...
			xhr.open("PUT", "/nsIncidentReportPXXXXXX/Incidents_CF/incident/IncidentPhotos(" + id + ")/image");
